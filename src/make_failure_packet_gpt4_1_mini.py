...
SCORES_CSV = Path("runs/adversarial/gpt4_1_mini/scored_results.csv")
OUTPUTS_JSONL = Path("runs/adversarial/gpt4_1_mini/model_outputs.jsonl")
OUT_MD = Path("runs/adversarial/gpt4_1_mini/analysis/failure_packet_sepsis_high_risk.md")
