...
SCORES_PATH = Path("runs/adversarial/gpt5_2/scored_results.csv")
OUT_DIR = Path("runs/adversarial/gpt5_2/analysis")
...
def main() -> None:
    ...
    constrained["model_escalation_label"] = constrained["model_escalation_raw"].map(lambda x: x.lower())
